 ...
 void frontscreen(void)
{
	...
	glColor3f(0,0,1);
	output(33,160," KARAVALI INSTITUTE OF TECHNOLOGY ");
	glColor3f(0,0,1);
	output(08.0,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(0,244,238);
	output(65,130,"A Mini Project On:-");
	glColor3f(0,244,238);
	output(10,120,"\"COMPUTER GRAPHICS AND VISUALIZATION (MAZE GAME) \"");
	glColor3f(0,0,1);
	output(40,100,"By :-");
	glBegin(GL_LINES);
	glVertex2f(40,98);
	...
	glEnd();
 glColor3f(255,173,0);
	output(40,90,"SHAIK MOHAMMED SHAHID (4KM20CS044)");
    output(40,78,"ASHRAF H S (4KM20CS004) ");
    output(40,66,"MOHAMMED OWAISE PASHA (4KM20CS026)");
    output(40,54,"AYAZULLA KHAN (4KM20CS005)");

	output(40,80,"");
	glColor3f(0,0,1);
	output(40,46,"Under the Guidence of :");
	glBegin(GL_LINES);
	glVertex2f(40,44);
	glVertex2f(88,44);
	glEnd();
	...
	output(40,48,"");
	glColor3f(255,173,2);
	drawstring(72,38,"MS.ASWANI M",GLUT_BITMAP_HELVETICA_18);
	glColor3f(1,0,0);
	drawstring(72,34,"Assistant Professor,Department of CSE",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(255,173,2);
	drawstring(72,26,"MS.DHANYA JAYAN ",GLUT_BITMAP_HELVETICA_18);
	glColor3f(1,0,0);
    drawstring(72,20,"Assistant Professor,Department of CSE",GLUT_BITMAP_HELVETICA_12);
	glFlush();
